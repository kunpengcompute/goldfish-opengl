...
LOCAL_MODULE := libInstructionEngine
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_SRC_FILES_arm :=${PARTITION}/lib/libInstructionEngine.so
LOCAL_SRC_FILES_arm64 :=${PARTITION}/lib64/libInstructionEngine.so
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE := libVmiInsCommon
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_SRC_FILES_arm :=${PARTITION}/lib/libVmiInsCommon.so
LOCAL_SRC_FILES_arm64 :=${PARTITION}/lib64/libVmiInsCommon.so
LOCAL_MODULE_TARGET_ARCHS:= arm arm64
LOCAL_VENDOR_MODULE := ${IS_BUILD_VENDOR_MODULE}
LOCAL_MULTILIB := both
include $(BUILD_PREBUILT)
