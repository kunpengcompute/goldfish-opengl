...
struct EmulatorFeatureInfo {
    ...
    EmulatorFeatureInfo() :
        ...
        hostComposition(HOST_COMPOSITION_V2),
        glesMaxVersion(GLES_MAX_VERSION_3_0),
        hasDirectMem(false),
        hasVulkan(true),
