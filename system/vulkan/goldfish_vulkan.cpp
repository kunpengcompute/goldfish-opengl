...
extern PFN_vkVoidFunction GetDeviceProcAddr(VkDevice device, const char* name);
static PFN_vkVoidFunction GetDeviceProcAddrInner(VkDevice device, const char* name) {
...
static PFN_vkVoidFunction GetDeviceProcAddr(VkDevice device, const char* name) {
    PFN_vkVoidFunction fn = GetDeviceProcAddrInner(device, name);
    ALOGD("GetDeviceProcAddr, device:%ld, Proc:%s addr:%p", device, name, fn);
    return fn;
}

VKAPI_ATTR
PFN_vkVoidFunction GetInstanceProcAddrInner(VkInstance instance, const char* name) {
    VK_HOST_CONNECTION(nullptr)
...
PFN_vkVoidFunction GetInstanceProcAddr(VkInstance instance, const char* name) {
    PFN_vkVoidFunction fn = GetInstanceProcAddrInner(instance, name);
    ALOGD("GetInstanceProcAddr, Instance:%ld, Proc:%s addr:%p", instance, name, fn);
    return fn;
}
...
public:
    ...
    PFN_vkVoidFunction GetInstanceProcAddr(VkInstance instance, const char* name) {
        AEMU_SCOPED_TRACE("VulkanDevice::GetInstanceProcAddr");
