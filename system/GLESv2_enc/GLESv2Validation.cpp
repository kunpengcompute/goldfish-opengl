...
#define COMPRESSED_TEX_IMAGE_SIZE_CASE(internal, multiplier) \
    ...
    switch (internalformat) {
    COMPRESSED_TEX_IMAGE_SIZE_CASE(GL_COMPRESSED_RGB_S3TC_DXT1_EXT, 8)
    COMPRESSED_TEX_IMAGE_SIZE_CASE(GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, 8)
    COMPRESSED_TEX_IMAGE_SIZE_CASE(GL_ETC1_RGB8_OES, 8)
...
#define COMPRESSED_TEX_IMAGE_IS_COMPRESSED_FORMAT_CASE(internal) \
    ...
    switch (internalformat) {
    COMPRESSED_TEX_IMAGE_IS_COMPRESSED_FORMAT_CASE(GL_COMPRESSED_RGB_S3TC_DXT1_EXT)
    COMPRESSED_TEX_IMAGE_IS_COMPRESSED_FORMAT_CASE(GL_COMPRESSED_RGBA_S3TC_DXT1_EXT)
    COMPRESSED_TEX_IMAGE_IS_COMPRESSED_FORMAT_CASE(GL_ETC1_RGB8_OES)
...
#define COMPRESSED_TEX_IMAGE_NOTSUPPORTED(internal) \
    ...
    switch (internalformat) {
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGB_S3TC_DXT1_EXT, 2, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, 2, 0)
    ...
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_4x4_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_5x4_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_5x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_6x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_6x6_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_8x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_8x6_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_8x8_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_10x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_10x6_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_10x8_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_10x10_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_12x10_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_RGBA_ASTC_12x12_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR, 3, 0)
    COMPRESSED_TEX_IMAGE_SUPPORT_CASE(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR, 3, 0)
    default:
        break;
    }
    return true;
